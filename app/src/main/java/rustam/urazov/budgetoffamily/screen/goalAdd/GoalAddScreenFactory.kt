...
class GoalAddScreenFactory(private val context: Context) : ViewModelProvider.Factory {
    ...
    private val addGoalUseCase by lazy {
        AddGoalUseCase(goalRepository)
    }

    override fun <T : ViewModel> create(modelClass: Class<T>): T =
        GoalAddScreenViewModel(fragmentManager, getAccessTokenUseCase, addGoalUseCase) as T
}
...
class IncomesSourceAddScreenFactory(private val context: Context) : ViewModelProvider.Factory {
    ...
    private val addIncomesSourceUseCase by lazy {
        AddIncomesSourceUseCase(incomesSourceRepository)
    }

    override fun <T : ViewModel> create(modelClass: Class<T>): T = IncomesSourceAddScreenViewModel(
        fragmentManager,
        getAccessTokenUseCase,
        addIncomesSourceUseCase
    ) as T
}